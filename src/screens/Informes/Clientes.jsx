...
const ComponentToPrint = React.forwardRef((props,ref)=>{    
    ...
    return ( 
        ...
        <div className="h-9 text-center mt-8">
            <h6 className="font-bold">Informe de Clientes Registrados</h6>                                                           
            <h6>
        ...
        <div className='border w-full p-1 mt-4'>
            <table className='border-collapse w-full'>
                <thead>
                    <tr className='h-7 border bg-gray-100'>                    
                        ...
                        <th className='w-2/12 border'>CI</th>
                        <th className='w-2/12 border'>Teléfono</th>                        
                    </tr>
                </thead>
                ...
                <tbody>
                    { props.pdata.map((it,index)=>(
                        <tr key={index} >
                            ...
                            <Moment format="DD/MM/YYYY">{it.createdAt}</Moment></td>                                               
                            <td className='border text-left pl-1'>{it.id}</td>
                            <td className='border text-left pl-1'>{it.nombres}</td>
                            <td className='border text-left pl-1'>{it.ci}</td>
                            <td className='border text-left pl-1'>{it.telefono}</td>
...
const Clientes = () => {    
    ...
    const {detalle, clientes, desde, total, hasta } = useSelector(state => state.informes)  
