...
const ComponentToPrint = React.forwardRef((props,ref)=>{    
    ...
    return ( 
        ...
        <div className="h-9 text-center mt-8">
            <h6 className="font-bold">Informe de Cajas</h6>                                                           
            <h6>
            ...
            <table className='border-collapse w-full'>
                <thead>
                    <tr className='h-7 border bg-gray-100'>                    
                        ...
                        <th className='w-2/12 border'>Inicial</th>                                                                                         
                        <th className='w-2/12 border'>Ingreso</th>    
                        <th className='w-2/12 border'>Egreso</th>
...
const Cajas = () => {    
    ...
    const { cajas, desde, hasta, total, detalle } = useSelector(state => state.informes)    
